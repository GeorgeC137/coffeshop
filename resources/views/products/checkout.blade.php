                ...
                <div class="col-md-12 ftco-animate">
                    <form method="post" action="{{ route('process.checkout') }}" class="billing-form ftco-bg-dark p-3 p-md-5">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="price" value="{{ Session::get('price') }}" type="hidden" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input name="user_id" value="{{ Auth::user()->id }}" type="hidden" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-12">
