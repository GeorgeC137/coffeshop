...
@section('content')
    ...
    <div class="container">
        @if (session('date'))
            <p class="alert {{ session('alert-class', 'alert-info') }}">{{ session('date') }}</p>
        @endif
    </div>

    <div class="container">
        @if (session('booking'))
            <p class="alert {{ session('alert-class', 'alert-info') }}">{{ session('booking') }}</p>
        @endif
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($products as $product)
                    <div class="col-md-3">
                        <div class="menu-entry">
                            <a href="{{ route('single.product', $product) }}" class="img"
                            ...
                            <div class="text text-center pt-4">
                                ...
                                <p><a href="{{ route('single.product', $product) }}"
